            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs" id="productCategoriesTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="{{$category_value->id}}" data-toggle="tab" href="#{{$category_value->name}}" role="tab" aria-controls="{{$category_value->name}}" aria-selected="true">
                                <div class="img-wrap">
                    ...
                    @foreach($category as $CategoryKey => $groupCategory)
                        ...
                        @endphp
                        <div class="tab-pane fade" id="{{$groupCategory->name}}" role="tabpanel" aria-labelledby="{{$tabId}}-tab">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="list-wrap">
                                                    ...
                                                    @endif
                                                    <a href="javascript:void(0);" data-group-category="{{$CategoryKey}}" class="category_click" data-id="{{$productCategoryKey}}" data-type="category">View All</a>
                                                </div>
                                            </td> 
                                        </tr>
